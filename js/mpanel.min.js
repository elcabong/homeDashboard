		...
		*/
			...
			$.get('./data/weather.json', function(data) {
				...
				if(difDate<1500000){
					...
					console.log("date close, using JSON");
			...
			function updateWeatherFromObject(){
				...
				document.getElementById('weather-current').innerHTML = '<div class="bright big">'
					...
					+	'</div>'
					+   '<div><span class="weather-forecast-item-low xxsmall">Last Checked: '+ currentTime +'</span></div>'				
					+   '<div><span class="weather-forecast-item-low xxsmall">Data Updated: '+ lastUpdated +'</span></div>';				
