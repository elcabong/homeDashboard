! function(t, e, s, n, o) {
    ...
    t.mPanel = function() {
		...
		*/
            ...
            e.getJSON("https://api.weatherbit.io/v2.0/current?postal_code="+t.settings.zipCode+"&units=I&key="+t.settings.weatherBitKey, function(wb) {
				...
				document.getElementById('weather-current').innerHTML = '<div class="bright big">'
					...
					+		'<br><span class="wi wi-sunrise"></span>  '+ sunrise.getHours() + ':' + sunrise.getMinutes() + ' am'
					+		'<br><span class="wi wi-sunset"></span>  '+ ((sunset.getHours() + 24) % 12 || 12) + ':' + sunset.getMinutes() + ' pm'
					+	'</div>';
				...
				e.getJSON("https://api.weatherbit.io/v2.0/forecast/daily?city="+t.settings.city+","+t.settings.state+"&key="+t.settings.weatherBitKey+"&hours=12&units=I", function(wb) {
					var daily = wb.data;
					...
					for(var count = 0; count < 5; count++){
						...
						+	'<span class="bright weather-forecast-item-high">'+ daily[count].max_temp+'<sup>°</sup>'
						+	'</span><br /><span class="bright weather-forecast-item-low xxsmall" style="margin: 0 10px;">'+ daily[count].min_temp+'<sup>°</sup>'
						+	'</span></div>';
