        ...
        return t.updateTime = function() {
            ...
            e.getJSON("http://api.wunderground.com/api/72df18b7f213607b/conditions/forecast/hourly/astronomy/q/CA/Sacramento.json", function(t) {
				...
				document.getElementById('weather-current').innerHTML = '<div class="bright big">'
					...
					+		'<span class="wi wi-strong-wind"></span> '+ WU.current_observation.wind_gust_mph+'mph '+ WU.current_observation.wind_dir
					+		'<br><span class="wi wi-sunrise"></span>  '+ WU.sun_phase.sunrise.hour +":"+WU.sun_phase.sunrise.minute+'am'
					+		'<br><span class="wi wi-sunset"></span>  '+ (WU.sun_phase.sunset.hour - 12) +":"+WU.sun_phase.sunset.minute+'pm'
					+	'</div>';					
				...
				for(var count in WU.forecast.simpleforecast.forecastday){
					...
					+	'<span class="bright weather-forecast-item-high">'+ WU.forecast.simpleforecast.forecastday[count].high.fahrenheit
				...
				for(var count in WU.hourly_forecast){
					...
					+	'<span class="bright weather-forecast-item-high">'+ WU.hourly_forecast[count].temp.english
